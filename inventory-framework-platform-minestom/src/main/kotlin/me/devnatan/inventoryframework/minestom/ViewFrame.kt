...
class ViewFrame private constructor(
...
) : me.devnatan.inventoryframework.platform.IFViewFrame<ViewFrame, View>() {
     ...
     * @param contextId The id of the context.
     * @param player Who the context will be open to.
     * @param initialData Initial data to pass to [me.devnatan.inventoryframework.platform.PlatformView.onViewerAdded].
     */
    @Experimental
    fun openActive(
        viewClass: Class<out View>,
